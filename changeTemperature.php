...
<html>
    ...
    <body ng-app="myapp" ng-controller="changetemController" id="content_body" onload="startTime(); startTime1()">
        <div class="container">
            ...
            <script>
                ...
                angular.module("myapp", [])
                    .controller("changetemController", function($scope,$http) {
                        $scope.humi = 0;
                        $scope.tempa = 0;
                        $scope.lstH = [];
                        for (var i = 60; i < 99; i++){
                        ...
                        $scope.sendToServer = function(){
                            ...
                            $http.post('http://127.0.0.1:5000/control', JSON.stringify(data)).then(function (response) {
